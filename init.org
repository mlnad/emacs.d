...
| Face              | Family            | Size |
|-------------------+-------------------+------|
| default           | Jet Brains Mono   |   16 |
| fixed-pitch       | Noto Sans CJK SC  |   16 |
| fixed-pitch-serif | Noto Serif CJK SC |   16 |
...
(add-hook 'after-init-hook #'moyu/apply-face-fonts)
(add-hook 'server-after-make-frame-hook #'moyu/apply-face-fonts)
#+end_src
